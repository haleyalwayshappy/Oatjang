...
<c:forEach items="${list }" var="ob">
	...
	<div class="replyButtonGroup">
		...
		<c:if test="${userid==ob.userid }">
			<a href="javascript:" onclick="deleteReply(${ob.rid})"
				class="replyButton">삭제</a>
			<a href="javascript:" onclick="updateReply(${ob.rid})"
				class="replyButton">수정</a>
		</c:if>
	</div>
